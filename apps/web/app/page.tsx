        ...
        <div className="max-w-6xl mx-auto px-6 h-18 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="flex items-center gap-2">
              <Image src="/sahay-logo.svg" alt="logo" height={32} width={106} />
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="max-w-3xl space-y-6">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-2xl">
                Sahay connects primary care facilities with district hospitals to ensure timely,
                safe, and transparent patient handoffs. No blind dispatching, no lost clinical
                context.
              </p>
            ...
            <div className="mt-20 p-8 rounded-lg border border-border bg-card shadow-sm">
              <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8 relative">
                ...
                <div className="flex flex-col items-center gap-3 bg-card px-4 z-10">
                  ...
                  <span className="text-xs font-mono font-medium text-foreground uppercase tracking-widest text-center">
                    Patient Context
                  </span>
                </div>
                ...
                <div className="flex flex-col items-center gap-3 bg-card px-4 z-10">
                  ...
                  <span className="text-xs font-mono font-bold text-primary uppercase tracking-widest text-center">
                    Active Handoff
                  </span>
                </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 lg:gap-24">
              <div>
                ...
                <div className="space-y-6 text-muted-foreground leading-relaxed">
                  <p>
                    In distributed healthcare networks, patient referrals often suffer from
                    fragmentation. When a frontline health worker issues a paper referral slip,
                    digital continuity ends.
                  </p>
                  <p>
                    Destination facilities receive patients without prior clinical context or
                    advance notification. Patients may arrive at facilities lacking the required
                    specialist capacity, resulting in delays, redirection, and loss of critical
                    time.
                  </p>
                  <p>
                    Sahay replaces informal, disconnected referral mechanisms with an explicit,
                    trackable state machine, ensuring every patient transition is accounted for.
                  </p>
                </div>
              </div>
              <div className="bg-surface-inset rounded-lg border border-border p-8 flex flex-col justify-center gap-8">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Paper records degrade or are lost in transit, forcing destination staff to
                      reassess from zero.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Patients are sent to facilities without confirmation of bed availability or
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      Originating clinics rarely receive outcome or discharge information for
                      community follow-up.
                    </p>
                  </div>
                </div>
              ...
              {[
                {
                  step: "01",
                  title: "Assess",
                  desc: "Capture structured patient vitals and clinical danger signs.",
                },
                {
                  step: "02",
                  title: "Route",
                  desc: "Identify an appropriate destination facility.",
                },
                {
                  step: "03",
                  title: "Refer",
                  desc: "Create and dispatch the handoff with full clinical context.",
                },
                {
                  step: "04",
                  title: "Handoff",
                  desc: "Destination staff review, accept, or safely redirect.",
                },
                {
                  step: "05",
                  title: "Follow Through",
                  desc: "Maintain visibility across the entire referral lifecycle.",
                },
              ].map((item, i) => (
                <div
                  key={item.step}
              ...
              {[
                {
                  ...
                  desc: "Standardized intake forms capturing specific vitals and danger signs for precise urgency calculation.",
                },
                {
                  icon: GitBranch,
                  title: "Referral Coordination",
                  desc: "Explicit state tracking (Sent, Accepted, Redirected) ensuring accountability at every step.",
                },
                {
                  icon: Building2,
                  title: "Facility Routing",
                  desc: "Directory-based selection allowing frontline workers to route patients to the correct tier of care.",
                },
                {
                  icon: FileText,
                  title: "Clinical Context",
                  desc: "Transmission of structured clinical data so receiving doctors can prepare before the patient arrives.",
                },
                {
                  icon: Activity,
                  title: "Handoff Tracking",
                  desc: "A chronological timeline of operational events, recording exactly when and by whom decisions are made.",
                },
                {
                  icon: LayoutDashboard,
                  title: "Follow-up Visibility",
                  desc: "Originating facilities maintain access to the status of their referred patients for community continuity.",
                },
              ].map((cap) => (
        ...
        <section className="py-24 border-b border-border bg-card">
          <div className="max-w-6xl mx-auto px-6 text-center max-w-3xl">
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              Sahay's data structures and workflows are designed with reference to clinical
              guidelines including WHO IMNCI and the Indian Public Health Standards (IPHS).
          ...
          <div className="max-w-6xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="bg-card p-8 rounded-lg border border-border flex flex-col h-full">
                <span className="font-mono text-xs font-bold text-primary mb-4 uppercase tracking-widest">
                  Origin Staff
                </span>
                <h3 className="text-xl font-semibold text-foreground mb-4">Community Clinics</h3>
                <ul className="space-y-3 text-sm text-muted-foreground flex-1">
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> Capture
                    structured clinical context
                  </li>
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> Initiate tracked
                    referrals
                  </li>
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> Monitor handoff
                    acceptance
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-card p-8 rounded-lg border border-border flex flex-col h-full">
                ...
                <ul className="space-y-3 text-sm text-muted-foreground flex-1">
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> Receive incoming
                    referrals in real-time
                  </li>
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> Review clinical
                    payload before arrival
                  </li>
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> Explicitly
                    Accept, Redirect, or Decline
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-card p-8 rounded-lg border border-border flex flex-col h-full">
                ...
                <ul className="space-y-3 text-sm text-muted-foreground flex-1">
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> District-wide
                    coordination oversight
                  </li>
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> Ensure protocol
                    adherence
                  </li>
                  <li className="flex gap-2">
                    <ArrowRight className="size-4 shrink-0 text-primary mt-0.5" /> Audit referral
                    timelines
                  </li>
                </ul>
              </div>
      ...
      <footer className="bg-card border-t border-border py-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-start gap-8">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <Image src="/sahay-logo.svg" alt="Sahay Logo" height={36} width={120} />
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-12 sm:gap-24">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>
                  <span className="text-muted-foreground">Technical Architecture</span>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6 mt-12 pt-8 border-t border-border flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <p className="text-xs text-muted-foreground font-mono">Clinical Operations Platform</p>
        </div>
      </footer>
    </div>
  );
